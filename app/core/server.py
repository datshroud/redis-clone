...
from app.core.dispatch import dispatch_command
from app.protocol.resp import RESPParser, resp_error
        ...
        while True:
            ...
            while True:
                ...
                if not isinstance(cmd, list):
                    writer.write(resp_error("ERR protocol error"))
                    await writer.drain()
                    continue
                resp = await dispatch_command(cmd)
                writer.write(resp)
                await writer.drain()
